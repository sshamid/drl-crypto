...
class StockEnvTrade(gym.Env):
    ...
    def __init__(self, df,day = 0,turbulence_threshold=140
        ...
        self.observation_space = spaces.Box(low=0, high=np.inf, shape = (STATE_SPACE_DIM,))
        ...
        self.state = [INITIAL_ACCOUNT_BALANCE] + \
              ...
              self.data[SENTIMENT_COLS[0]].tolist() + \
              self.data[SENTIMENT_COLS[1]].tolist() + \
              self.data[SENTIMENT_COLS[2]].tolist()
        # initialize reward
        self.reward = 0
        self.turbulence = 0
        self.cost = 0
    ...
    def step(self, actions):
        ...
        #print(f'self.terminal state {self.terminal}')
